...
namespace
{
    PFNGLBINDFRAMEBUFFERPROC            glBindFramebufferFunc            = 0;
    PFNGLBINDRENDERBUFFERPROC           glBindRenderbufferFunc           = 0;
    PFNGLCHECKFRAMEBUFFERSTATUSPROC     glCheckFramebufferStatusFunc     = 0;
    PFNGLDELETEFRAMEBUFFERSPROC         glDeleteFramebuffersFunc         = 0;
    PFNGLDELETERENDERBUFFERSPROC        glDeleteRenderbuffersFunc        = 0;
    PFNGLFRAMEBUFFERRENDERBUFFERPROC    glFramebufferRenderbufferFunc    = 0;
    PFNGLGENFRAMEBUFFERSPROC            glGenFramebuffersFunc            = 0;
    PFNGLGENRENDERBUFFERSPROC           glGenRenderbuffersFunc           = 0;
    PFNGLGETRENDERBUFFERPARAMETERIVPROC glGetRenderbufferParameterivFunc = 0;
    PFNGLRENDERBUFFERSTORAGEPROC        glRenderbufferStorageFunc        = 0;
    ...
    void ensureInit()
    {
        ...
        if (!initialized)
        {
            ...
            glBindFramebufferFunc            = reinterpret_cast<PFNGLBINDFRAMEBUFFERPROC>           (sf::priv::EaglContext::getFunction("glBindFramebuffer"));
            glBindRenderbufferFunc           = reinterpret_cast<PFNGLBINDRENDERBUFFERPROC>          (sf::priv::EaglContext::getFunction("glBindRenderbuffer"));
            glCheckFramebufferStatusFunc     = reinterpret_cast<PFNGLCHECKFRAMEBUFFERSTATUSPROC>    (sf::priv::EaglContext::getFunction("glCheckFramebufferStatus"));
            glDeleteFramebuffersFunc         = reinterpret_cast<PFNGLDELETEFRAMEBUFFERSPROC>        (sf::priv::EaglContext::getFunction("glDeleteFramebuffers"));
            glDeleteRenderbuffersFunc        = reinterpret_cast<PFNGLDELETERENDERBUFFERSPROC>       (sf::priv::EaglContext::getFunction("glDeleteRenderbuffers"));
            glFramebufferRenderbufferFunc    = reinterpret_cast<PFNGLFRAMEBUFFERRENDERBUFFERPROC>   (sf::priv::EaglContext::getFunction("glFramebufferRenderbuffer"));
            glGenFramebuffersFunc            = reinterpret_cast<PFNGLGENFRAMEBUFFERSPROC>           (sf::priv::EaglContext::getFunction("glGenFramebuffers"));
            glGenRenderbuffersFunc           = reinterpret_cast<PFNGLGENRENDERBUFFERSPROC>          (sf::priv::EaglContext::getFunction("glGenRenderbuffers"));
            glGetRenderbufferParameterivFunc = reinterpret_cast<PFNGLGETRENDERBUFFERPARAMETERIVPROC>(sf::priv::EaglContext::getFunction("glGetRenderbufferParameteriv"));
            glRenderbufferStorageFunc        = reinterpret_cast<PFNGLRENDERBUFFERSTORAGEPROC>       (sf::priv::EaglContext::getFunction("glRenderbufferStorage"));
        }
    }
}
...
m_clock       ()
{
    ...
    // Create the context
    if (shared)
        m_context = [[EAGLContext alloc] initWithAPI:kEAGLRenderingAPIOpenGLES2 sharegroup:[shared->m_context sharegroup]];
    else
...
void EaglContext::recreateRenderBuffers(SFView* glView)
{
    ...
    GLenum status = glCheckFramebufferStatusFunc(GL_FRAMEBUFFER);
