...
inline int SF_GL_OES_blend_subtract = 1;
inline int SF_GL_OES_blend_func_separate = 1;
inline int SF_GL_OES_blend_equation_separate = 1;
inline int SF_GL_OES_framebuffer_object = 1;
...
#define GLEXT_OES_blend_subtract_dependencies ::sf::priv::SF_GL_OES_blend_subtract, glBlendEquation
...
#define GLEXT_blend_func_separate_dependencies ::sf::priv::SF_GL_OES_blend_func_separate, glBlendFuncSeparate
...
#define GLEXT_framebuffer_object_dependencies                                                                  \
    ::sf::priv::SF_GL_OES_framebuffer_object, glBindRenderbuffer, glDeleteRenderbuffers, glGenRenderbuffers,   \
